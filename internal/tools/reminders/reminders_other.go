...
// internal/tools/reminders/reminders_other.go
package reminders
...
func (t *GetRemindersTool) Info(_ context.Context) (*schema.ToolInfo, error) {
	return base.InfoFromSchema(t.Name(), "获取 macOS 提醒事项（仅 macOS 支持）", nil), nil
}
...
func (t *CompleteReminderTool) Info(_ context.Context) (*schema.ToolInfo, error) {
	return base.InfoFromSchema(t.Name(), "标记提醒事项为已完成（仅 macOS 支持）", nil), nil
}
