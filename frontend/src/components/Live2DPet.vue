...
import { GetBallPosition, SaveBallPosition, GetConfig, SaveConfig, GetPetSize } from '../../bindings/aiko/internal/services/configservice'
import { GetScreenSize, GetMousePosition } from '../../bindings/aiko/internal/services/windowservice'
